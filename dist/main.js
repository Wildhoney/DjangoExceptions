...
var Prelude = __webpack_require__(1);
var ArrayLookup = (function () {
    function ArrayLookup(value0) {
        this.value0 = value0;
    };
    ArrayLookup.create = function (value0) {
        return new ArrayLookup(value0);
    };
    return ArrayLookup;
})();
var StrMapLookup = (function () {
    function StrMapLookup(value0) {
        this.value0 = value0;
    };
    StrMapLookup.create = function (value0) {
        return new StrMapLookup(value0);
    };
    return StrMapLookup;
})();
var Empty = (function () {
...
var read = function (m) {
    return function (f) {
        var wrap = function (a) {
            var $1 = Data_Foreign.isArray(Data_Foreign.toForeign(a));
            if ($1) {
                return new ArrayLookup(a);
            };
            return StrMapLookup.create(Data_StrMap.singleton("firstName")([ "Nothing", "Nope" ]));
        };
        var messages = (function () {
            var v = Data_Array.last(f);
            if (v instanceof Data_Maybe.Just) {
                return Data_Maybe.maybe(Empty.value)(wrap)(Data_StrMap.lookup(v.value0)(m));
            };
            if (v instanceof Data_Maybe.Nothing) {
                return Empty.value;
            };
            throw new Error("Failed pattern match at Exceptions line 19, column 20 - line 21, column 30: " + [ v.constructor.name ]);
        })();
        if (messages instanceof ArrayLookup) {
            return [ {
                field: f, 
                messages: messages.value0
            } ];
        };
        if (messages instanceof StrMapLookup) {
            return parse(messages.value0)(f);
        };
        ...
        throw new Error("Failed pattern match at Exceptions line 13, column 12 - line 16, column 64: " + [ messages.constructor.name ]);
    };
};
var parse = function (m) {
    return function (f) {
        return Data_Array.concatMap(function (field) {
            return read(m)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(f)([ field ]));
        })(Data_StrMap.keys(m));
    };
};
module.exports = {
